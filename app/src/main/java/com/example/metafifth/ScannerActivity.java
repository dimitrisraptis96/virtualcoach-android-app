...
public class ScannerActivity extends AppCompatActivity implements ServiceConnection, ScannerCommunicationBus {
        ...
        mwBoard.connectAsync()
                ...
                .continueWith(task -> {
                    if (!task.isCancelled()) {
                        ...
                        //here we pass from scanner to main after we get a connection and our device is btDevice
                        Intent navActivityIntent = new Intent(ScannerActivity.this, MainActivity.class);
                        navActivityIntent.putExtra(MainActivity.EXTRA_BT_DEVICE, btDevice);
